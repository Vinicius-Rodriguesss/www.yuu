...
export const appointmentsTable = pgTable("appointments", {
  ...
  endedAt: timestamp("ended_at"), // término real (preenchido ao marcar "completed"); libera a agenda a partir daqui
  paymentStatus: varchar("payment_status", { length: 20 }).notNull().default("unpaid"), // paid, unpaid
  notes: text(),
